...
var wordsToGuess = ["Hello", "World is beautiful", "It's My Life", "Spiderwebs", "Harry Potter", "Tragic Kingdom", "Tale of two cities", "The leader who had no Title", "New", "Trapped In A Box", "Rock Steady"];
var randomWord;
var chosenWord;
    ...
    inquirer.prompt([
        ...
        .then(function (inquirerResponse) {
            if (inquirerResponse.confirm) {
                ...
                console.log(chalk.blue("OK fine.. 'DON'T SPEAK' to me ever again!"));
                process.exit();
            }
        })
}
